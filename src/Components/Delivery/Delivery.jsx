            ...
            <div className="grid grid-cols-4">
                <div className="delivery_wrapper">
                    <div className="flex items-center gap-4">
                        <p><Percent size='3rem' className="text-gray-700" /></p>
                        <div>
                ...
                <div className="delivery_wrapper">
                    <div className="flex items-center gap-4">
                        <p><Truck size='3rem' className="text-gray-700" /></p>
                        <div>
                ...
                <div className="delivery_wrapper">
                    <div className="flex items-center gap-4">
                        <p><Clock3 size='3rem' className="text-gray-700" /></p>
                        <div>
                ...
                <div className="delivery_wrapper">
                    <div className="flex items-center gap-4">
                        <p><ShieldCheck size='3rem' className="text-gray-700"/></p>
                        <div>
